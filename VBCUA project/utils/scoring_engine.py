...
def evaluate_understanding(similarity, filler_ratio, audio):
    """
    Computes a composite understanding score (0ΓÇô100) by combining:
      - Semantic similarity (0ΓÇô1 scale): up to 50 points
    ...
    """
    logger.info("Evaluating understanding ΓÇö similarity=%.4f, filler_ratio=%.4f, audio=%s",
