...
class TestSpeechToText:
    ...
    def test_validate_transcription_empty(self):
        from legacy.modules.speech_to_text import validate_transcription
...
class TestSemanticEngine:
    ...
    def test_get_available_concepts_returns_list(self):
        from legacy.modules.semantic_engine import get_available_concepts
    ...
    def test_generate_embedding_shape(self):
        from legacy.modules.semantic_engine import generate_embedding
    ...
    def test_cosine_similarity_identical(self):
        from legacy.modules.semantic_engine import generate_embedding, compute_cosine_similarity
    ...
    def test_normalize_similarity_clips_negative(self):
        from legacy.modules.semantic_engine import normalize_similarity
    ...
    def test_semantic_similarity_high_for_correct_explanation(self):
        from legacy.modules.semantic_engine import semantic_similarity
        good_explanation = (
...
class TestAudioFeatures:
    ...
    def test_filler_word_ratio_no_fillers(self):
        from legacy.modules.audio_features import filler_word_ratio
    ...
    def test_evaluate_understanding_strong(self):
        from legacy.modules.audio_features import evaluate_understanding
    ...
    def test_get_feedback_returns_list(self):
        from legacy.modules.audio_features import get_feedback
